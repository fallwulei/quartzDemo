...
public class QuartzManager {
	...
	public static void addJob(String jobName, Job job, String time) throws SchedulerException, ParseException {
		...
		JobDetail jobDetail = newJob(HelloJob.class).withIdentity(jobName, JOB_GROUP_NAME).build();
		// 触发器
		//CronTrigger trigger = new CronTrigger(jobName, TRIGGER_GROUP_NAME);// 触发器名,触发器组
		CronTrigger trigger = newTrigger().withIdentity("trigger1", "group1").startAt(runTime).build();
